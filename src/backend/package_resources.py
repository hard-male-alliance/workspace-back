...
_CONTRACT_SCHEMA: Final[str] = "ai-job-workspace.contract.schema.json"
"""@brief 运行时权威 JSON Schema 文件 / Authoritative runtime JSON Schema file."""


def read_contract_schema_text() -> str:
...
def _packaged_contract() -> Traversable:
    ...
    return files(_PACKAGE_NAME).joinpath(_RESOURCE_DIRECTORY, _CONTRACT_SCHEMA)


def _source_contract() -> Path | None:
